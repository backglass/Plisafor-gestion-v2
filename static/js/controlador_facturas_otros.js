    ...
    function sumar_total(){
        ...
        document.getElementById("iva_input").value=  0; // Añadido limete 2 de numeros decimales para que no se vuelva loco a la hora de hacer los cálculos
        iva = total * 0.21;
        iva.toFixed(2);
        document.getElementById("total_con_iva").value = (total).toFixed(2); 
